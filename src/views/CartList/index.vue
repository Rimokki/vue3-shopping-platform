<script setup lang="ts">
  ...
  const { totalCount, selectedCount, selectedPrice, isAllChecked } = storeToRefs(cartStore)

  const changeSelected = (id: string, selected: boolean) => {
    cartStore.singleCheck(id, selected)
  }

  const changeAllSelected = (selected: boolean) => {
      ...
      <div class="cart">
        <table>
          <thead>
            <tr>
              <th width="120">
                <el-checkbox :model-value="isAllChecked" @change="changeAllSelected" />
              </th>
            ...
            <tr v-for="i in cartStore.cartList" :key="i.id">
              <td>
                <el-checkbox
                  ...
                  @change="changeSelected(i.skuId as string, $event)" />
              </td>
              <td>
                <div class="goods">
              ...
              <td class="tc">
                <p>
                  <el-popconfirm
                    ...
                    @confirm="cartStore.deleteCart(i.skuId as string)">
                    <template #reference>
