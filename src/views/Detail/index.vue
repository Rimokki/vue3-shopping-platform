        ...
        <div>
          <div class="goods-info">
            <div class="media">
              ...
              <ul class="goods-sales">
                ...
                <li>
                  <p>品牌信息</p>
                  <p>{{ goods?.brand ? goods.brand.name : '无' }}</p>
          ...
          <div class="goods-footer">
            ...
            <div class="goods-aside">
              <DetailHot v-if="goods?.hotByDay" :goodsList="goods.hotByDay" title="24小时热销" />
              <detailHot
                v-if="goods?.similarProducts"
                :goodsList="goods.similarProducts"
                title="猜你喜欢" />
            </div>
          </div>
        </div>
