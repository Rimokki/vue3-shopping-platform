<script setup lang="ts">
  ...
  import type { CheckoutInfo } from '@/apis/checkout'
  import { useCartStore } from '@/stores/cart'

  const checkInfo = ref<CheckoutInfo>()
  const curAddress = ref<CheckoutInfo['userAddresses'][0]>()
  const activeAddress = ref<CheckoutInfo['userAddresses'][0]>()
  ...
  const switchAddress = (item: CheckoutInfo['userAddresses'][0]) => {
  ...
  const createOrder = async () => {
    if (checkInfo.value && curAddress.value) {
