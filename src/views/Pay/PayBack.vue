<script setup lang="ts">
  ...
  import type { OrderResult } from '@/apis/pay'
  ...
  <div class="xtx-pay-page">
    <div class="container" v-loading="loading">
      ...
      <div class="pay-result">
        <span class="iconfont icon-queren2 green" v-if="$route.query.result === 'true'"></span>
        <span class="iconfont icon-shanchu red" v-else></span>
        <p class="tit">支付{{ $route.query.result === 'true' ? '成功' : '失败' }}</p>
